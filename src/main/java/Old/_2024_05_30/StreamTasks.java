...
//                .sorted(Comparator.comparingDouble(el-> el.age))
...
//                new Person("Jennifer", 19, "New York", "jennifer@example.com", 52000),
//                new Person("Tom", 40, "San Francisco", "tom@example.com", 70000),
...
//        System.out.println("Task 22: " + tasks.task22(people));
