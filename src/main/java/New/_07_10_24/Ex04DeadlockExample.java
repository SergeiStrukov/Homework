    ...
    public static void main(String[] args) {
        Thread thread1 = new Thread(() -> {
            synchronized (RESOURCE_1) {
                ...
                try {
                    Thread.sleep(100); // Имитируем какую-то работу, удерживая ресурс 1
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
                System.out.println("Поток 1: Ожидает ресурс 2");
                synchronized (RESOURCE_2) { // Ожидает захват ресурса 2
        ...
        Thread thread2 = new Thread(() -> {
            synchronized (RESOURCE_2) {
                ...
                try {
                    Thread.sleep(100); // Имитируем какую-то работу, удерживая ресурс 2
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
                System.out.println("Поток 2: Ожидает ресурс 1");
                synchronized (RESOURCE_1) { // Ожидает захват ресурса 1
